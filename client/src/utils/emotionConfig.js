export const EMOTIONS = {
  happiness:  { color: '#FFD700', valence:  0.8, arousal: 0.5, label: 'Mutlu',     icon: '☀️' },
  sadness:    { color: '#4169E1', valence: -0.7, arousal: 0.2, label: 'Üzgün',     icon: '🌧️' },
  anger:      { color: '#DC143C', valence: -0.8, arousal: 0.9, label: 'Sinirli',   icon: '⛈️' },
  calm:       { color: '#2E8B57', valence:  0.5, arousal: 0.1, label: 'Sakin',     icon: '🌿' },
  excitement: { color: '#FF8C00', valence:  0.9, arousal: 0.9, label: 'Heyecanlı', icon: '✨' },
  anxiety:    { color: '#8B008B', valence: -0.5, arousal: 0.8, label: 'Endişeli',  icon: '🌀' },
  tired:      { color: '#708090', valence: -0.2, arousal: 0.1, label: 'Yorgun',    icon: '🌙' },
  hopeful:    { color: '#FF69B4', valence:  0.6, arousal: 0.4, label: 'Umutlu',    icon: '🌅' },
};
